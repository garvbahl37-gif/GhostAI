...
// ═══════════════════════════════════════════════════════════════════════════════
// Navbar — identical to landing page style
// ═══════════════════════════════════════════════════════════════════════════════
  ...
  return (
    <header
      ...
      style={{
        ...
        background: scrolled ? "rgba(194,191,184,0.82)" : "transparent",
    ...
    >
      ...
      >
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
          ...
          >
            GhostCustomer
            <sup style={{ fontSize: "0.48em", fontWeight: 400, verticalAlign: "super" }}>®</sup>
          </span>
          <span
            style={{
        ...
        >
          {NAV.map((item) => (
            <Link
              ...
              style={{
                color: "#0d0d0d",
                textDecoration: item.href === "/dashboard" ? "underline" : "none",
                textUnderlineOffset: 4,
                textDecorationColor: "rgba(13,13,13,0.5)",
                opacity: 1,
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            style={{
              background: "rgba(194,191,184,0.97)",
